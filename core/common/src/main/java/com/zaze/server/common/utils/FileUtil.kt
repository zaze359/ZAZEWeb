...
//        }
    ...
    // --------------------------------------------------
    // --------------------------------------------------
    private fun isStorageEnable(): Boolean {
        return true
    }

    fun getRootPath(): String {
//        return ResourceUtils.getURL("classpath:").path
...
//        return ""
    ...
    fun createFileNotExists(file: File): Boolean {
        ...
        if (showLog) {
            ZLog.d(TAG, "create ${file.absolutePath}: $result")
        }
        return result
    }
    // --------------------------------------------------
    ...
    fun deleteFile(destFile: File): Boolean {
        if (getRootPath() == destFile.absolutePath) {
            return false
        }
        if (destFile.isFile) {
...
//        ZLog.i(TAG, "getTotalSpace : ${file.path}")
